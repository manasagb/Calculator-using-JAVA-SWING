...
public class MyCalculator {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 265, 369);
		...
		textField.setBounds(10, 11, 230, 33);
		frame.getContentPane().add(textField);
		textField.setColumns(10);
		
		final JButton btnA = new JButton("<-");
		...
		btnPlus.setBounds(190, 110, 50, 50);
		...
		btnSub.setBounds(190, 165, 50, 50);
		...
		btnMul.setBounds(190, 220, 50, 50);
		...
		btnPM.setFont(new Font("Tahoma", Font.PLAIN, 10));
		btnPM.setBounds(130, 275, 50, 50);
		...
		btnEqual.setBounds(190, 275, 50, 50);
